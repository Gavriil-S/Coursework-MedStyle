...
#КонецЕсли
	...
	ЕстьЛицензия = РаботаСЛицензиями.ПроверитьЛицензию(СисИнфо.ИдентификаторКлиента);
	Если НЕ ЕстьЛицензия Тогда
		ОткрытьФорму("ОбщаяФорма.ПроверкаЛицензии",,,,,,,РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
	КонецЕсли;
